...
| Идея | `idea` | Предложение по улучшению платформы |
| Баг | `bug` | Сообщение об ошибке |
| Другое | `other` | Прочие contributions |
...
**Полный URL:** `POST https://api.edgelab.su/api/v1/contributions/submit`
...
<ParamField body="type" type="string" required>
  Тип: `skill`, `usecase`, `lesson`, `idea`, `bug` или `other`
</ParamField>
...
**Полный URL:** `GET https://api.edgelab.su/api/v1/contributions/my`
...
<CodeGroup>
```bash cURL
curl "https://api.edgelab.su/api/v1/contributions/my?status=approved&limit=10&offset=0" \
  -H "Authorization: Bearer edgelab_live_abc123"
```
</CodeGroup>
  ...
  "items": [
    {
      ...
      "title": "Full test",
      "status": "pending",
      "created_at": "2026-03-23T23:10:42Z",
      "updated_at": "2026-03-23T23:10:42Z"
    }
  ],
  "total": 3,
  "limit": 20,
...
**Полный URL:** `GET https://api.edgelab.su/api/v1/contributions/{id}`
...
<CodeGroup>
```bash cURL
curl https://api.edgelab.su/api/v1/contributions/3 \
  -H "Authorization: Bearer edgelab_live_abc123"
```
</CodeGroup>
