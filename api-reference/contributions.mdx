...
Contributions -- механизм вклада в экосистему EdgeLab. Участники на тарифах Pro и VIP могут предложить скилл, use case или урок. Одобренные работы публикуются в разделе Knowledge с указанием автора.
...
<Info>
**Вознаграждение:** Bounty программа вознаграждения для контрибьюторов [запланирована на Q2 2026](/concepts/roadmap). Одобренные contributions приносят поинты и попадание в лидерборд.
</Info>
