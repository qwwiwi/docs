...
<Info>
**Доступность:** Чтение событий (`events:read`) доступно на **всех тарифах** (Edge, Pro, VIP). Создание событий (`events:write`) -- только Pro и VIP.
</Info>
...
<Info>
Создание событий доступно только участникам с scope `events:write` (тарифы **Pro** и **VIP**). Участники на тарифе Edge могут просматривать события, но не предлагать новые.
</Info>
