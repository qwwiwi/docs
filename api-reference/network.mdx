...
**Полный URL:** `GET https://api.edgelab.su/api/v1/network/members`
...
**Полный URL:** `GET https://api.edgelab.su/api/v1/network/matches`
...
**Полный URL:** `POST https://api.edgelab.su/api/v1/network/connect`

### Параметры запроса (body)

| Параметр | Тип | Обязательный | Описание |
|---|---|---|---|
| `target_member_id` | integer | Да | ID участника, которому отправляется запрос |
...
<CodeGroup>
```bash cURL
curl -X POST https://api.edgelab.su/api/v1/network/connect \
  -H "Authorization: Bearer edgelab_live_abc123" \
  -H "Content-Type: application/json" \
  -d '{
    "target_member_id": 164795011,
...
**Полный URL:** `GET https://api.edgelab.su/api/v1/network/requests`
...
**Полный URL:** `PATCH https://api.edgelab.su/api/v1/network/requests/{id}`
...
<CodeGroup>
```bash cURL
curl -X PATCH https://api.edgelab.su/api/v1/network/requests/1 \
  -H "Authorization: Bearer edgelab_live_abc123" \
  -H "Content-Type: application/json" \
  -d '{"action": "accept"}'
```
