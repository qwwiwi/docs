...
- Аккаунт на [EdgeLab](https://api.edgelab.su)
...
Перейди на [api.edgelab.su](https://api.edgelab.su) и создай аккаунт. API доступен на всех тарифах, но объём функций зависит от уровня:
...
```bash curl
curl -X GET https://api.edgelab.su/api/v1/knowledge/list \
...
BASE_URL = "https://api.edgelab.su/api/v1"
  ...
  "items": [
    {
      ...
      "description": "Формат воркшопа: 4 созвона за 7 дней.",
      "cover_url": "",
      "category": "live",
      "content_type": "mixed",
      "duration_minutes": 12,
