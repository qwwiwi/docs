...
export EDGELAB_API_KEY="el_live_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4"
```

```bash Файл ~/.secrets/
mkdir -p ~/.secrets
echo 'EDGELAB_API_KEY=el_live_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4' > ~/.secrets/edgelab.env
...
op item create --category=api_credential \
  ...
  "credential=el_live_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4"
```
</CodeGroup>
